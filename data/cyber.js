...
window.CONFIG = {
 ...
 {tk:"PANW",nm:"Palo Alto Networks",bz:"Security platform (all-domain)",color:"#FA582D",layer:"platform",share:{pct:20,rank:"#1",conf:"high",market:"enterprise network security"},price:265.43,mcap:216,cur:"$",mcapUSD:true,
  ...
  r:{val:3,growth:8,roic:7,moat:9,fcf:9,bs:8,scal:9},
  m:{peTTM:214,peFwd:64,pegFwd:3.5,evEbitda:60,evSales:22,pfcf:50,fcfYield:1.9,revCagrHist:15,epsCagrFwd:18,gross:74,op:18,net:12,roic:4,roe:20,fcfMargin:37,fcfConv:110,sbc:8,netDebtEbitda:0.2,intCov:99},
  d:{revPS:11.7,netCashPS:-1,fcfM:0.38}},
 ...
 {tk:"CRWD",nm:"CrowdStrike",bz:"Endpoint + cloud (Falcon)",color:"#E01F3D",layer:"platform",share:{pct:25,rank:"#1",conf:"high",market:"modern endpoint protection"},price:642.8,mcap:167,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:999,peFwd:95,pegFwd:4,evEbitda:80,evSales:30,pfcf:80,fcfYield:0.6,revCagrHist:25,epsCagrFwd:25,gross:75,op:8,net:5,roic:8,roe:10,fcfMargin:30,fcfConv:120,sbc:9,netDebtEbitda:-1,intCov:99},
  d:{revPS:20,netCashPS:15,fcfM:0.34}},
 ...
 {tk:"FTNT",nm:"Fortinet",bz:"Network security (firewall ASIC)",color:"#EE3124",layer:"platform",share:{pct:18,rank:"#2",conf:"high",market:"network firewall appliances"},price:136.7,mcap:104,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:40,peFwd:28.6,pegFwd:1.8,evEbitda:24,evSales:13,pfcf:30,fcfYield:3,revCagrHist:13,epsCagrFwd:16,gross:80,op:32,net:25,roic:22,roe:60,fcfMargin:32,fcfConv:110,sbc:4,netDebtEbitda:-1,intCov:999},
  d:{revPS:9.2,netCashPS:2.8,fcfM:0.32}},
 ...
 {tk:"ZS",nm:"Zscaler",bz:"Cloud security / SASE (ZTNA)",color:"#0075C9",layer:"cloud",share:{pct:25,rank:"#1",conf:"high",market:"secure web gateway / ZTNA"},price:144,mcap:22.6,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:999,peFwd:60,pegFwd:2,evEbitda:55,evSales:7,pfcf:40,fcfYield:1.8,revCagrHist:25,epsCagrFwd:18,gross:80,op:5,net:3,roic:6,roe:8,fcfMargin:25,fcfConv:120,sbc:18,netDebtEbitda:-1,intCov:99},
  d:{revPS:21,netCashPS:11,fcfM:0.23}},
 ...
 {tk:"NET",nm:"Cloudflare",bz:"Edge network + security",color:"#F38020",layer:"cloud",share:{pct:15,rank:"#2",conf:"medium",market:"edge network & application security"},price:234.5,mcap:87.5,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:999,peFwd:180,pegFwd:5,evEbitda:90,evSales:30,pfcf:90,fcfYield:0.4,revCagrHist:30,epsCagrFwd:30,gross:77,op:4,net:3,roic:5,roe:7,fcfMargin:12,fcfConv:110,sbc:12,netDebtEbitda:-0.3,intCov:99},
  d:{revPS:7.4,netCashPS:1.8,fcfM:0.13}},
 ...
 {tk:"OKTA",nm:"Okta",bz:"Workforce & customer identity",color:"#00297A",layer:"identity",share:{pct:20,rank:"#2",conf:"medium",market:"workforce identity & access mgmt"},price:81,mcap:14.2,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:61,peFwd:28,pegFwd:2.6,evEbitda:22,evSales:5,pfcf:22,fcfYield:4.6,revCagrHist:12,epsCagrFwd:12,gross:76,op:8,net:8,roic:6,roe:7,fcfMargin:25,fcfConv:110,sbc:14,netDebtEbitda:-1,intCov:99},
  d:{revPS:16.7,netCashPS:11,fcfM:0.30}},
 ...
 {tk:"S",nm:"SentinelOne",bz:"Autonomous endpoint + AI SecOps",color:"#6B2F91",layer:"detect",share:{pct:8,rank:"#3",conf:"medium",market:"modern endpoint protection"},price:12.5,mcap:4.53,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:999,peFwd:80,pegFwd:4,evEbitda:60,evSales:4.5,pfcf:70,fcfYield:5,revCagrHist:22,epsCagrFwd:30,gross:75,op:-12,net:-15,roic:-12,roe:-8,fcfMargin:5,fcfConv:60,sbc:18,netDebtEbitda:-1.5,intCov:99},
  d:{revPS:3,netCashPS:2.5,fcfM:0.22}},
 ...
 {tk:"RPD",nm:"Rapid7",bz:"SIEM + vulnerability management",color:"#1E8E6B",layer:"detect",share:{pct:6,rank:"#4",conf:"low",market:"vulnerability management + SIEM"},price:7.15,mcap:0.48,cur:"$",mcapUSD:true,
  ...
  r:{val:7,growth:2,roic:5,moat:5,fcf:7,bs:5,scal:6},
  m:{peTTM:8,peFwd:6,pegFwd:1,evEbitda:9,evSales:1.5,pfcf:6,fcfYield:27,revCagrHist:2,epsCagrFwd:5,gross:70,op:8,net:6,roic:8,roe:30,fcfMargin:18,fcfConv:100,sbc:8,netDebtEbitda:2.5,intCov:8},
  d:{revPS:13.5,netCashPS:-4,fcfM:0.16}},
 ...
 {tk:"QLYS",nm:"Qualys",bz:"Cloud vulnerability & compliance",color:"#ED2E26",layer:"exposure",share:{pct:8,rank:"#3",conf:"medium",market:"cloud vulnerability management"},price:111.53,mcap:3.06,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:22,peFwd:19,pegFwd:1.2,evEbitda:14,evSales:4,pfcf:18,fcfYield:8,revCagrHist:10,epsCagrFwd:12,gross:80,op:30,net:28,roic:29,roe:40,fcfMargin:38,fcfConv:110,sbc:5,netDebtEbitda:-2,intCov:999},
  d:{revPS:26,netCashPS:12,fcfM:0.38}},
 ...
 {tk:"TENB",nm:"Tenable",bz:"Exposure management (Nessus)",color:"#00558C",layer:"exposure",share:{pct:10,rank:"#2",conf:"medium",market:"vulnerability / exposure management"},price:27.85,mcap:3.08,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:999,peFwd:25,pegFwd:0.6,evEbitda:18,evSales:3,pfcf:20,fcfYield:8.6,revCagrHist:11,epsCagrFwd:22,gross:77,op:6,net:-3,roic:8,roe:20,fcfMargin:20,fcfConv:100,sbc:8,netDebtEbitda:0.9,intCov:10},
  d:{revPS:8.3,netCashPS:-0.56,fcfM:0.25}},
 ...
 {tk:"GEN",nm:"Gen Digital",bz:"Consumer cyber-safety (Norton)",color:"#FDB511",layer:"exposure",share:{pct:40,rank:"#1",conf:"high",market:"consumer cybersecurity subscriptions"},price:24.82,mcap:15,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:17,peFwd:9,pegFwd:0.5,evEbitda:12,evSales:5,pfcf:11,fcfYield:10,revCagrHist:27,epsCagrFwd:15,gross:82,op:50,net:30,roic:9,roe:40,fcfMargin:40,fcfConv:100,sbc:3,netDebtEbitda:3.85,intCov:8},
  d:{revPS:8,netCashPS:-11,fcfM:0.30}}
]
};

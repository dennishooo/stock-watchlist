  ...
  "data": [
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The franchise of the decade — tirzepatide plus the newly approved oral Foundayo (orforglipron, cleared in a record ~50 days), with the Jul-26 Medicare GLP-1 Bridge opening a $50-copay senior channel. Q1 26 revenue +56%, FY26 guide $82-85B; ~$1.16T cap at ~30x fwd on ~22% EPS CAGR — premium but PEG ~1.3, ROIC ~42%.",
      "bull": "Foundayo oral approval plus Medicare Bridge access; best-in-class incretin efficacy, deep pipeline, ROIC &gt;40%.",
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "Past the Humira cliff — Skyrizi/Rinvoq did a combined $25.9B in 2025, already above the firm's 2027 peak guidance; FY26 adj EPS guide $14.08-14.28. Stock at all-time highs (~$255, +13% since mid-June) has rerated to ~17-18x fwd; strong FCF (~34% margin) and dividend, ~13% EPS CAGR, but ND/EBITDA ~2.4 and the rerating trim the margin of safety.",
      "bull": "Skyrizi/Rinvoq durable double-digit growth replacing Humira; strong FCF and dividend.",
      "bear": "Rerated to ~18x fwd at all-time highs; large debt load (GAAP P/E inflated by amortization); pipeline must keep filling.",
      "r": {
        "val": 5,
        "growth": 7,
        "roic": 7,
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The picks-and-shovels giant of biopharma — instruments, bioprocessing and CDMO. FY26 EPS guide $24.64-25.12 on 6-8% reported growth; stock has rallied ~9% since mid-June to ~$523 (~21x fwd) ahead of the Jul-23 Q2 print, Street mean ~$600. Recovery on track, but EV/EBITDA ~20 and ND/EBITDA ~3.5 leave it fair-to-full, no longer cheap.",
      "bull": "Scaled tools plus CDMO levered to obesity-drug manufacturing; guidance raised, recovery underway.",
      "bear": "Rally to ~21x fwd already prices the recovery; China and academic-funding exposure; ND/EBITDA ~3.5.",
      "r": {
        "val": 4,
        "growth": 6,
        "roic": 7,
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "A premium tools compounder centered on high-margin bioprocessing consumables — recovery finally turning (RBC resumed Outperform, $200 PT) but Q1 core organic was only ~0.5% and the stock sits near 52-week lows (~$178). Now layering on a $9.9B Masimo acquisition (patient monitoring) that re-levers the balance sheet. ~20-22x fwd, PEG ~2.6 — quality priced ahead of visible recovery.",
      "bull": "High-margin recurring bioprocessing consumables; disciplined capital allocation; ~4% FCF yield.",
      "bear": "Bioprocessing recovery still nascent; $9.9B Masimo deal adds integration risk and leverage; ~21x fwd.",
      "r": {
        "val": 4,
        "growth": 6,
        "roic": 7,

...
window.CONFIG = {
 ...
 {tk:"LLY",nm:"Eli Lilly",bz:"GLP-1 leader (tirzepatide)",color:"#D52B1E",layer:"glp1",share:{pct:50,rank:"#1",conf:"high",market:"incretin / GLP-1 obesity & diabetes"},price:1153.81,mcap:1020,cur:"$",mcapUSD:true,
  ...
  r:{val:3,growth:10,roic:9,moat:10,fcf:8,bs:8,scal:9},
  m:{peTTM:50,peFwd:32,pegFwd:1.4,evEbitda:32,evSales:17,pfcf:55,fcfYield:1.2,revCagrHist:32,epsCagrFwd:22,gross:82,op:42,net:28,roic:42,roe:60,fcfMargin:22,fcfConv:80,sbc:2,netDebtEbitda:1.2,intCov:40},
  d:{revPS:70,netCashPS:-49,fcfM:0.15}},
 ...
 {tk:"NVO",nm:"Novo Nordisk",bz:"GLP-1 co-leader (semaglutide)",color:"#001965",layer:"glp1",share:{pct:45,rank:"#2",conf:"high",market:"incretin / GLP-1 obesity & diabetes"},price:42,mcap:187,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:9.95,peFwd:13.37,pegFwd:1,evEbitda:7.7,evSales:4,pfcf:15,fcfYield:4.8,revCagrHist:6,epsCagrFwd:8,gross:84,op:45,net:35,roic:40,roe:80,fcfMargin:25,fcfConv:85,sbc:1,netDebtEbitda:0.7,intCov:99},
  d:{revPS:10,netCashPS:-4.3,fcfM:0.18}},
 ...
 {tk:"VKTX",nm:"Viking Therapeutics",bz:"Obesity biotech (VK2735)",color:"#E8590C",layer:"challenger",share:{pct:5,rank:"#5",conf:"low",market:"next-gen incretin obesity drugs"},price:29.17,mcap:3.97,cur:"$",mcapUSD:true,
  ...
  d:{revPS:0,netCashPS:5.2,fcfM:-3}},
 ...
 {tk:"AMGN",nm:"Amgen",bz:"Biotech + obesity (MariTide)",color:"#0063C3",layer:"challenger",share:{pct:8,rank:"#4",conf:"medium",market:"biologics + monthly incretin"},price:354,mcap:189,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:17,peFwd:15,pegFwd:2.2,evEbitda:12,evSales:5,pfcf:16,fcfYield:4.3,revCagrHist:5,epsCagrFwd:7,gross:75,op:40,net:28,roic:18,roe:90,fcfMargin:30,fcfConv:90,sbc:2,netDebtEbitda:2.8,intCov:9},
  d:{revPS:71,netCashPS:-85,fcfM:0.22}},
 ...
 {tk:"HIMS",nm:"Hims & Hers",bz:"Telehealth + GLP-1 distribution",color:"#0F7C5A",layer:"challenger",share:{pct:10,rank:"#3",conf:"low",market:"D2C telehealth & weight-loss"},price:30,mcap:6.8,cur:"$",mcapUSD:true,
  ...
  d:{revPS:12,netCashPS:-1.1,fcfM:0.08}},
 ...
 {tk:"PFE",nm:"Pfizer",bz:"Diversified pharma + oral obesity",color:"#0093D0",layer:"pharma",share:{pct:6,rank:"#5",conf:"medium",market:"diversified branded pharmaceuticals"},price:25.65,mcap:146,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:11,peFwd:8.9,pegFwd:1.5,evEbitda:8,evSales:3,pfcf:11,fcfYield:6.6,revCagrHist:2,epsCagrFwd:6,gross:72,op:28,net:22,roic:7,roe:12,fcfMargin:18,fcfConv:90,sbc:2,netDebtEbitda:2.1,intCov:9},
  d:{revPS:10.7,netCashPS:-9.1,fcfM:0.15}},
 ...
 {tk:"MRK",nm:"Merck",bz:"Pharma (Keytruda) + cardio-metabolic",color:"#00857C",layer:"pharma",share:{pct:10,rank:"#3",conf:"high",market:"oncology + diversified pharma"},price:120,mcap:295,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:17,peFwd:12,pegFwd:1.6,evEbitda:10,evSales:4,pfcf:14,fcfYield:5,revCagrHist:1,epsCagrFwd:9,gross:75,op:38,net:30,roic:21,roe:30,fcfMargin:25,fcfConv:90,sbc:1,netDebtEbitda:1.5,intCov:30},
  d:{revPS:26,netCashPS:-17,fcfM:0.21}},
 ...
 {tk:"ABBV",nm:"AbbVie",bz:"Immunology + diversified pharma",color:"#071D49",layer:"pharma",share:{pct:12,rank:"#2",conf:"high",market:"immunology biologics"},price:229,mcap:405,cur:"$",mcapUSD:true,
  ...
  r:{val:6,growth:7,roic:7,moat:8,fcf:9,bs:4,scal:6},
  m:{peTTM:106,peFwd:15,pegFwd:1.1,evEbitda:14,evSales:6,pfcf:17,fcfYield:5.9,revCagrHist:9,epsCagrFwd:13,gross:70,op:35,net:15,roic:14,roe:80,fcfMargin:30,fcfConv:90,sbc:2,netDebtEbitda:2.4,intCov:9},
  d:{revPS:35,netCashPS:-36,fcfM:0.34}},
 ...
 {tk:"RHHBY",nm:"Roche",bz:"Pharma + diagnostics (CH)",color:"#0066CC",layer:"pharma",share:{pct:11,rank:"#2",conf:"medium",market:"oncology + diagnostics"},price:50.55,mcap:315,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:21,peFwd:17,pegFwd:2.2,evEbitda:13,evSales:2.5,pfcf:18,fcfYield:4.8,revCagrHist:4,epsCagrFwd:8,gross:72,op:30,net:22,roic:15,roe:30,fcfMargin:22,fcfConv:90,sbc:1,netDebtEbitda:1,intCov:30},
  d:{revPS:21,netCashPS:-3.5,fcfM:0.2}},
 ...
 {tk:"TMO",nm:"Thermo Fisher",bz:"Life-science tools & CDMO",color:"#E1251B",layer:"tools",share:{pct:20,rank:"#1",conf:"high",market:"life-science tools + bioprocessing"},price:469.63,mcap:174.5,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:28,peFwd:19,pegFwd:2.1,evEbitda:18,evSales:4,pfcf:26,fcfYield:3.9,revCagrHist:5,epsCagrFwd:9,gross:42,op:22,net:16,roic:9,roe:14,fcfMargin:18,fcfConv:90,sbc:2,netDebtEbitda:3.5,intCov:15},
  d:{revPS:117,netCashPS:-107,fcfM:0.14}},
 ...
 {tk:"DHR",nm:"Danaher",bz:"Bioprocessing & diagnostics tools",color:"#0067B1",layer:"tools",share:{pct:18,rank:"#2",conf:"high",market:"bioprocessing + diagnostics tools"},price:185.71,mcap:131.4,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:32,peFwd:20,pegFwd:2.8,evEbitda:20,evSales:5.5,pfcf:30,fcfYield:4,revCagrHist:4,epsCagrFwd:8,gross:60,op:25,net:18,roic:7,roe:12,fcfMargin:20,fcfConv:90,sbc:2,netDebtEbitda:1.9,intCov:20},
  d:{revPS:35,netCashPS:-21.5,fcfM:0.24}},
 ...
 {tk:"ISRG",nm:"Intuitive Surgical",bz:"Robotic surgery (da Vinci)",color:"#7A2E8E",layer:"devices",share:{pct:80,rank:"#1",conf:"high",market:"soft-tissue surgical robotics"},price:483,mcap:172.6,cur:"$",mcapUSD:true,
  ...
  d:{revPS:30,netCashPS:22.5,fcfM:0.28}},
 ...
 {tk:"DXCM",nm:"Dexcom",bz:"Continuous glucose monitoring",color:"#9C4DCC",layer:"devices",share:{pct:40,rank:"#1",conf:"high",market:"continuous glucose monitors"},price:77.24,mcap:29.8,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:31,peFwd:25,pegFwd:1.2,evEbitda:20,evSales:6,pfcf:35,fcfYield:4.4,revCagrHist:16,epsCagrFwd:20,gross:62,op:18,net:15,roic:14,roe:20,fcfMargin:18,fcfConv:95,sbc:5,netDebtEbitda:-0.5,intCov:99},
  d:{revPS:12,netCashPS:1.6,fcfM:0.18}}
]
};

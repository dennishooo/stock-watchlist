  ...
  "data": [
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The leading trapped-ion pure-play; Q1 26 revenue $64.7M (+755%), FY26 guide ~$260-270M, but still deeply loss-making with ~$3.1B net cash. Stock has cooled to ~$49 (~$18B cap) — the valuation remains a long-dated option on fault tolerance and quantum networking.",
      "bull": "Highest-profile pure-play; networking optionality and a deep ~$3.1B cash pile.",
      "bear": "~$18B cap on sub-$300M revenue; deep losses; long road to fault tolerance.",
      "r": {
        "val": 1,
        "growth": 10,
        "roic": 1,
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "A speculative photonic-quantum and thin-film-chip story; Q1 26 revenue $3.7M with negative gross margin and a ~$20.6M op loss. Closed the $73.1M NHanced Semiconductors acquisition, adding advanced-packaging capacity to the foundry plan, funded by a ~$1.4B cash pile. Binary, hype-driven outcomes.",
      "bull": "Photonic approach plus a chip-foundry angle, now with NHanced packaging capacity; ~$1.4B cash cushion.",
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The three-way split completed 29 Jun 2026: aerospace (HONA) and Solstice spun off; remainco renamed Honeywell Technologies — a ~$73B pure-play automation company (1-for-2 reverse split; FY26 guide ~$20B sales, ~20% segment margin) still holding 49.1% of Quantinuum, worth ~$9.5B (~13% of the cap) after QNT's post-IPO run to ~$19.5B.",
      "bull": "49.1% Quantinuum stake (~$9.5B, ~13% of cap) inside a focused, ~20%-margin automation pure-play.",
      "bear": "Slim automation core grows slowly; post-spin financials unsettled; Quantinuum stake hostage to a volatile post-IPO tape.",
      "r": {
        "val": 5,
        "growth": 5,
        "roic": 8,

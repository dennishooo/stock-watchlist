...
window.CONFIG = {
 ...
 {tk:"IBM",nm:"IBM",bz:"Enterprise quantum (Nighthawk/roadmap)",color:"#1F70C1",layer:"bigtech",share:{pct:25,rank:"#1",conf:"medium",market:"enterprise quantum systems & cloud"},price:277.3,mcap:258,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:26,peFwd:22,pegFwd:2.6,evEbitda:15,evSales:4,pfcf:18,fcfYield:5,revCagrHist:4,epsCagrFwd:7,gross:56,op:18,net:14,roic:12,roe:40,fcfMargin:16,fcfConv:90,sbc:3,netDebtEbitda:2.2,intCov:12},
 ...
 {tk:"GOOGL",nm:"Alphabet",bz:"Quantum (Willow) + AI",color:"#EA4335",layer:"bigtech",share:{pct:25,rank:"#1",conf:"medium",market:"quantum research (Willow chip)"},price:361.85,mcap:4400,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:26,peFwd:22,pegFwd:1.4,evEbitda:15,evSales:7,pfcf:26,fcfYield:3,revCagrHist:16,epsCagrFwd:14,gross:58,op:32,net:28,roic:30,roe:32,fcfMargin:24,fcfConv:90,sbc:4,netDebtEbitda:-1,intCov:999},
 ...
 {tk:"FORM",nm:"FormFactor",bz:"Cryogenic test & probe cards",color:"#1E8E6B",layer:"enabling",share:{pct:40,rank:"#1",conf:"medium",market:"semiconductor probe cards + cryo test"},price:142.69,mcap:9.73,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:134,peFwd:40,pegFwd:1.7,evEbitda:22,evSales:12,pfcf:40,fcfYield:1.5,revCagrHist:8,epsCagrFwd:15,gross:42,op:16,net:13,roic:12,roe:12,fcfMargin:14,fcfConv:90,sbc:4,netDebtEbitda:-1.5,intCov:999},

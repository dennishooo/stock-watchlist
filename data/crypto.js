...
window.CONFIG = {
 ...
 {tk:"COIN",nm:"Coinbase",bz:"Crypto exchange + custody",color:"#0052FF",layer:"exchange",share:{pct:50,rank:"#1",conf:"high",market:"U.S. regulated crypto exchange"},price:174,mcap:54,cur:"$",mcapUSD:true,
  ...
  r:{val:3,growth:8,roic:7,moat:8,fcf:7,bs:7,scal:9},
  m:{peTTM:30,peFwd:44,pegFwd:3.3,evEbitda:20,evSales:9,pfcf:30,fcfYield:4,revCagrHist:30,epsCagrFwd:15,gross:85,op:35,net:30,roic:18,roe:25,fcfMargin:35,fcfConv:95,sbc:8,netDebtEbitda:-1,intCov:99},
  d:{revPS:23,netCashPS:10,fcfM:0.35}},
 ...
 {tk:"HOOD",nm:"Robinhood",bz:"Retail brokerage + crypto",color:"#00C805",layer:"exchange",share:{pct:15,rank:"#3",conf:"medium",market:"retail brokerage + crypto trading"},price:85,mcap:75,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:55,peFwd:38,pegFwd:1,evEbitda:35,evSales:18,pfcf:45,fcfYield:3.1,revCagrHist:45,epsCagrFwd:25,gross:88,op:45,net:38,roic:10,roe:15,fcfMargin:40,fcfConv:110,sbc:8,netDebtEbitda:-3,intCov:999},
  d:{revPS:4,netCashPS:6,fcfM:0.64}},
 ...
 {tk:"RIOT",nm:"Riot Platforms",bz:"Bitcoin miner + AI/HPC pivot",color:"#F7931A",layer:"miner",share:{pct:10,rank:"#2",conf:"low",market:"Bitcoin hash-rate + HPC hosting"},price:25.2,mcap:9.56,cur:"$",mcapUSD:true,
  ...
  r:{val:4,growth:9,roic:1,moat:4,fcf:2,bs:7,scal:7},
  ...
  d:{revPS:1.7,netCashPS:-1.8,fcfM:-0.25}},
 ...
 {tk:"CLSK",nm:"CleanSpark",bz:"Bitcoin miner (low-cost power)",color:"#0AC18E",layer:"miner",share:{pct:8,rank:"#3",conf:"low",market:"Bitcoin hash-rate"},price:16.82,mcap:4.1,cur:"$",mcapUSD:true,
  ...
  d:{revPS:1.9,netCashPS:-3.06,fcfM:-0.15}},
 ...
 {tk:"IREN",nm:"IREN Limited",bz:"Bitcoin miner + AI cloud",color:"#5B2A86",layer:"miner",share:{pct:8,rank:"#4",conf:"low",market:"Bitcoin hash-rate + AI cloud"},price:55.4,mcap:19.8,cur:"$",mcapUSD:true,
  ...
  d:{revPS:1.7,netCashPS:11,fcfM:-0.1}},
 ...
 {tk:"MSTR",nm:"Strategy",bz:"Bitcoin treasury (leveraged)",color:"#FF9900",layer:"treasury",share:{pct:40,rank:"#1",conf:"medium",market:"public Bitcoin treasury holdings"},price:154.2,mcap:54,cur:"$",mcapUSD:true,
  ...
  r:{val:4,growth:8,roic:3,moat:5,fcf:3,bs:4,scal:8},
  ...
  d:{revPS:1.4,netCashPS:-59,fcfM:-0.05}},
 ...
 {tk:"CRCL",nm:"Circle Internet",bz:"USDC stablecoin issuer",color:"#1E8E6B",layer:"stablecoin",share:{pct:80,rank:"#1",conf:"high",market:"fiat-backed stablecoins (USDC)"},price:79.12,mcap:21.73,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:80,peFwd:45,pegFwd:1,evEbitda:40,evSales:8,pfcf:55,fcfYield:2.4,revCagrHist:40,epsCagrFwd:35,gross:40,op:30,net:28,roic:12,roe:18,fcfMargin:30,fcfConv:100,sbc:6,netDebtEbitda:-1,intCov:99},
  d:{revPS:10.2,netCashPS:6,fcfM:0.17}},
 ...
 {tk:"BLK",nm:"BlackRock",bz:"Crypto asset mgmt (IBIT ETF)",color:"#000000",layer:"services",share:{pct:50,rank:"#1",conf:"high",market:"spot crypto ETF assets (IBIT)"},price:1050,mcap:160,cur:"$",mcapUSD:true,
  ...
  m:{peTTM:24,peFwd:21,pegFwd:1.4,evEbitda:16,evSales:7,pfcf:22,fcfYield:2.3,revCagrHist:9,epsCagrFwd:11,gross:50,op:38,net:30,roic:11,roe:15,fcfMargin:33,fcfConv:95,sbc:2,netDebtEbitda:0.3,intCov:40},

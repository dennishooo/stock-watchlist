...
window.CONFIG = {
  ...
  "data": [
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "A pre-revenue developer of the high-grade Rook I project in Saskatchewan — final CNSC licence granted, with full-scale construction starting summer 2026 on a ~48-month build to first production; ~$1.0B cash + investments (plus 2.7Mlb U3O8 inventory) funds early works, but the full build needs more capital. Valued on resource leverage and execution, not returns.",
      "bull": "World-class high-grade deposit, now fully licensed and in construction; ~$1.3B adjusted working capital.",
      "bear": "Pre-revenue; 4-year build with financing, execution and uranium-price risk still ahead.",
      "r": {
        "val": 1,
        "growth": 9,
        "roic": 1,
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The first NRC-certified SMR design — a call option on factory-made reactors; Q1'26 revenue fell ~96% YoY (to ~$0.6M) on a ~$44M quarterly net loss, against ~$1.2B liquidity. TVA/ENTRA1 and RoPower projects advance while commercialization timelines keep slipping; valued on optionality and runway, not returns.",
      "bull": "First-mover certified SMR; TVA/ENTRA1 and RoPower pipelines advancing; ~$1.2B liquidity.",
      "bear": "Pre-commercial and cash-burning; Q1'26 revenue down ~96%; commercialization-timeline doubts.",
      "r": {
        "val": 1,
        "growth": 10,
        "roic": 1,
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The only US-owned enricher scaling HALEU for advanced reactors; a $900M DOE production contract signed Jul '26 (up to ~$1.07B with options) plus a ~$3.9B backlog through 2040 underpin the Piketon expansion. Profitable with ~$2B net cash, but FY26 revenue of ~$450-500M is modest against a ~55x trailing multiple.",
      "bull": "$900M DOE HALEU award + ~$3.9B backlog to 2040; strategic US enrichment franchise; ~$2B net cash.",
      "bear": "Lumpy revenue and Piketon capex ahead; ~55x trailing P/E already prices strategic optionality.",
      "r": {
        "val": 4,
        "growth": 9,
        "roic": 7,
    ...
    },
    {
      ...
      "bull": "Power-price upside + nuclear PTC floor; Helix AI-infrastructure JV with KKR/Nvidia; ~7% FCF yield, buybacks.",
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The electrification pure-play spun from GE — gas turbines, grid hardware and nuclear services; FY26 guidance raised to ~$45B revenue with 12-14% EBITDA margin on a record backlog and ~$10B net cash. But the stock is +70% YTD to a ~$300B cap — roughly 50x forward earnings prices a flawless super-cycle.",
      "bull": "Raised FY26 guide (~$45B rev, 12-14% EBITDA margin); record turbine/grid backlog; net cash.",
      "bear": "+70% YTD to a ~$300B cap; ~50x fwd leaves no room for execution slips.",
      "r": {
        "val": 2,
        "growth": 9,
        "roic": 7,
    ...
    },
    {
      ...
      "cur": "$",
      "mcapUSD": true,
      "thesis": "The largest US renewables developer wrapped around premium regulated FPL — now merging with Dominion in a $67B all-stock deal (0.8138 NEE per share) to create the largest regulated utility, adding Virginia's Data Center Alley and a ~130-GW large-load pipeline; ~23x forward on ~13% growth, with ~6x EBITDA leverage, negative FCF from capex and deal-approval risk the key offsets.",
      "bull": "Dominion deal adds Data Center Alley + ~130-GW large-load pipeline atop a best-in-class renewables machine.",
      "bear": "All-stock dilution and merger-approval risk; ~6x leverage, negative FCF, policy/tax-credit exposure.",
      "r": {
        "val": 5,
        "growth": 7,
        "roic": 6,
